...
void capture_by_value()
{
    ...
    auto lambda = [=] {
        return make_tuple(obj_1.get_id(), obj_2.get_id());
    };
    auto [id1, id2] = lambda();
    cout << "Size of lambda is When capture is by val: " << sizeof(lambda) << std::endl;
}
...
void capture_by_reference()
{
    ...
    auto [id1, id2] = lambda();
    cout << "Size of lambda is When capture is by ref: " << sizeof(lambda) << std::endl;
}
