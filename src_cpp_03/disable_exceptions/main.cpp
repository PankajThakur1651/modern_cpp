...
int main() {
    ...
    no_rtti(); //
    // c++ compilers are as good as the cC compilers ( Gcc, Clang, MSVC, INTEL compiler)
    // c++ compilers are not as widely supported as C compilers on embedded platforms (True)
