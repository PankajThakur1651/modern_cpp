...
template <>
std::string addition<std::string>(std::string a, std::string b)
{
...
int main()
{
    ...
    std::cout << "Sum of 11.55 and 12.55 is " << addition(11.55, 12.55) << std::endl;

    // Template specialization for chars (concatenating them as a string)
    std::cout << "Sum of 'A' and 'B' is " << addition(std::string("ABCD"), std::string("EFGH")) << std::endl;  // This will print "AB"
